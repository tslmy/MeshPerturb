%% Set file names for study
%Change these when the study changes
%Do not change file names in any other pre/processing files
...
log_file='.\log.txt';
seed_linear='linear_analysis_seed.mph';
weight_results='.\AmpVsEpsilon_0.xlsx';             %File for amplitude versus epsilon for a given non linear model
study_name='.\weightVsParam.xlsx';                %File for minimum weight versus parameters (for all linear models in the study)
