...
%weight_results='.\epsilonVsAmp_0.xlsx';             %File for weight versus amplitude for a given linear model
study_name='.\Phase_dia.xlsx';                %File for results versus parameters (for all linear models in the study)