function out = nonlinear_analysis_seed(modifiedMesh,weight_factor,imp_period,linear_period)
%
...
model.modelPath('.\Weight factor study');
...
model.param.set('epsilonp', '5e-2', 'Initial prestretch strain');
model.param.set('epsilon0', '0', 'Final strain');
model.param.set('epsilon', '0', 'Current strain value (varies from epsilonp to epsilon0)');
model.param.set('nsteps', '100', 'Number of steps for load ramp-up');
model.param.set('Et', '70e9 [Pa]', 'Young''s modulus of top layer');
model.param.set('Mub', '2e6 [Pa]', 'Modulus of base layer');
model.param.set('weight',weight_factor , 'Weight of initial imperfection');
model.param.set('I_period',imp_period , 'Period of initial imperfection');
model.param.set('linear_period',linear_period , 'Period from linear analysis');
