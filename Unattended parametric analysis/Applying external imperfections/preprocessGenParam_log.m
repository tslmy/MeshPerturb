...
nonlinear_multiplier= @(i) logspace(log10(f_lb_nl(i)),log10(f_ub_nl(i)),steps_nl(i));
...
%Varying all parameters simulatneously for nonlinear analysis  (logarithmic scale)
