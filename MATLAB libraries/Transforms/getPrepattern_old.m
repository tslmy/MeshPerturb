function imperfection = getPrepattern_old(rawData,weight,period, plateThickness,height)
%Generates prepatterns to be added to mesh coordinates (as imperfection to mesh) 
% Input: (rawData,weight,period, plateThickness, height)
...
% period: Period of imperfections
...
% Note: this program exact copy of getImperfection, except for switch_mode=1
