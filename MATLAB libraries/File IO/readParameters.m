function [parameters, units, p_with_units_values p_with_units] = readParameters(model)
...
p_names_nounits={'L', 'H', 'W', 'hf' ,'epsilonp', 'epsilon0', 'nsteps', 'Et', 'Mub', 'epsilon'};
[ L H W hf ep e0 nsteps Et Mub e units]=mphglobal(model,p_names_nounits,'SolNum', 'end');

parameters=[L H W hf ep e0 nsteps Et Mub e];
