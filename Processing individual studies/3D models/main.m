...
mkdir(rootdir);
mph_linear='linear_analysis_seed3d.mph';                   %Linear analysis file in .mph format

%% Set system parameters
Nmp=100;                           %Number of mid-plane coordinates along length (used in step 5)
...
nonlinearModel=nonlinear_analysis_seed3d(modifiedMesh, weight_factor);    
try 
