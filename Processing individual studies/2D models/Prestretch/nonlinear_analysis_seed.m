...
%
% linear_analysis_seedV2.m
%
% Model exported on Jul 23 2013, 20:57 by COMSOL 4.2.0.228.
...
model.comments('Nonlinear buckling analysis');
...
model.view('view1').axis.set('xmin', '0.151885986328125');
model.view('view1').axis.set('xmax', '19.848114013671875');
model.view('view1').axis.set('ymin', '-5.249228000640869');
model.view('view1').axis.set('ymax', '8.324357986450195');
...
model.sol('sol1').feature('s1').feature.create('pDef', 'Parametric');
...
model.sol('sol1').feature('s1').feature('pDef').set('control', 'stat');
model.sol('sol1').feature('s1').feature('pDef').set('pname', {'epsilon'});
model.sol('sol1').feature('s1').feature('pDef').set('plist', 'range(epsilonp,(epsilon0-epsilonp)/(nsteps-1),epsilon0)');
